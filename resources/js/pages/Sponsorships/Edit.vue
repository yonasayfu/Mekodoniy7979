...
<template>
    ...
    <AppLayout :breadcrumbs="[{ title: 'Sponsorships', href: route('sponsorships.index') }, { title: `Sponsorship ${sponsorship.id}`, href: route('sponsorships.edit', sponsorship.id) }]">
    <div class="flex flex-col gap-4">
        <div>
            ...
            <p class="text-sm text-slate-600 dark:text-slate-300">
                Update details for Sponsorship {{ sponsorship.id }} by {{ sponsorship.user.name }} for {{ sponsorship.elder.first_name }} {{ sponsorship.elder.last_name }}.
            </p>
        </div>
            ...
            <form class="space-y-5" @submit.prevent="submit">
                ...
                <div class="flex items-center justify-end gap-2 pt-2">
                    <GlassButton
                        ...
                        variant="secondary"
                    >
                        <Link :href="route('sponsorships.index')" class="flex items-center gap-2">Cancel</Link>
                    </GlassButton>
