...
const approvalSummary = computed(() => {
    ...
    const formatted = Number.isNaN(date.getTime())
        ? props.user.approved_at
        : approvedFormatter.format(date);

    return props.user.approved_by
        ? `${formatted} - ${props.user.approved_by}`
        : formatted;
});
...
<template>
    ...
    >
        <div class="space-y-6">
            ...
            <div
                class="rounded-lg border border-slate-200/80 bg-white/80 p-4 text-sm shadow-sm dark:border-slate-700/80 dark:bg-slate-900/60"
            >
                <p
                ...
                <div class="mt-2 flex flex-wrap items-center gap-3 text-sm">
                    <span
                        class="inline-flex items-center rounded-full bg-indigo-100 px-3 py-1 text-xs font-semibold text-indigo-700 dark:bg-indigo-500/20 dark:text-indigo-100"
                    >
            ...
            >
                <div>
                    ...
                    <p class="text-xs text-slate-500 dark:text-slate-400">
                        Role assignments and profile updates applied to this
                        account.
                    </p>
                </div>
