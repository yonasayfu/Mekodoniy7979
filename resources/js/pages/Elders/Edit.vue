...
<template>
    ...
    <AppLayout
        :breadcrumbs="[
            { title: 'Elders', href: route('elders.index') },
            {
                title: `${elder.first_name} ${elder.last_name}`,
        ...
        <div class="flex flex-col gap-4">
            <div>
                ...
                <p class="text-sm text-slate-600 dark:text-slate-300">
                    Update details for {{ elder.first_name }}
                    {{ elder.last_name }}.
                </p>
            </div>
            ...
            <GlassCard>
                <form class="space-y-5" @submit.prevent="submit">
                    ...
                    <div>
                        ...
                        ></textarea>
                        <InputError
                            :message="form.errors.special_needs"
                            class="mt-2"
                        />
                    </div>
                    <div>
                        ...
                        />
                        <InputError
                            :message="form.errors.monthly_expenses"
                            class="mt-2"
                        />
                    </div>
                    <div>
