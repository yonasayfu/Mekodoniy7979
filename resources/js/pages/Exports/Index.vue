    ...
    <AppLayout :breadcrumbs="[{ title: 'Download Center', href: '/exports' }]">
        <div class="space-y-6">
            ...
            <GlassCard variant="lite" padding="p-0">
                <div
                    class="overflow-hidden rounded-xl border border-slate-200/70 bg-white/80 dark:border-slate-800/60 dark:bg-slate-900/50"
                >
                    <table
                    ...
                    >
                        <thead class="bg-slate-50/80 dark:bg-slate-900/80">
                            <tr>
                                ...
                                <th
                                    class="px-5 py-3 text-center text-xs font-semibold tracking-wide text-slate-500 uppercase dark:text-slate-400"
                                >
                                    Records
                                </th>
                                <th
                                ...
                                <th
                                    class="px-5 py-3 text-right text-xs font-semibold tracking-wide text-slate-500 uppercase dark:text-slate-400"
                                >
                                    Actions
                                </th>
                            </tr>
                        ...
                        >
                            <tr v-if="!hasResults">
                                ...
                                >
                                    No exports yet. Generate an export from any
                            ...
                            >
                                ...
                                <td
                                    class="px-5 py-4 text-center text-sm text-slate-600 dark:text-slate-300"
                                >
                                    {{ item.record_count }}
                                </td>
                                <td
                                ...
                                >
                                    <div>
                                        {{
                                            item.completed_at_human ?? 'Pending'
                                        }}
                                    </div>
                                    <div
