...
<template>
    ...
    <AppLayout :breadcrumbs="[{ title: 'Visits', href: route('visits.index') }, { title: `Visit ${visit.id}`, href: route('visits.edit', visit.id) }]">
    <div class="flex flex-col gap-4">
        <div>
            ...
            <p class="text-sm text-slate-600 dark:text-slate-300">
                Update details for Visit {{ visit.id }} by {{ visit.user.name }} for {{ visit.elder.first_name }} {{ visit.elder.last_name }}.
            </p>
        </div>
            ...
            <form class="space-y-5" @submit.prevent="submit">
                ...
                <div class="flex items-center justify-end gap-2 pt-2">
                    <GlassButton
                        ...
                        variant="secondary"
                    >
                        <Link :href="route('visits.index')" class="flex items-center gap-2">Cancel</Link>
                    </GlassButton>
