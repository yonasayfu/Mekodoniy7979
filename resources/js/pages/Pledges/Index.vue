    ...
    <AppLayout :breadcrumbs="[{ title: 'Pledges', href: '/pledges' }]">
        <div class="space-y-6">
            <ResourceToolbar
                ...
                :create-route="canCreate ? '/pledges/create' : undefined"
                ...
                >
                    ...
                    >
                        <tr v-if="!hasResults">
                            ...
                            >
                                No pledges match your filters yet. Add a new
                                pledge to get started.
                            </td>
                        </tr>
                        <tr
                            v-for="(pledge, index) in pledgeList"
                            v-else
                            :key="pledge.id"
                        ...
                        >
                            ...
                            >
                                <Link
                                    :href="
                                        route('elders.show', pledge.elder_id)
                                    "
                                    class="transition hover:text-indigo-600 dark:hover:text-indigo-300"
                                >
