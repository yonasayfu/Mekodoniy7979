...
const submit = () => {
    form.post(route('pledges.store'));
};
</script>

<template>
    <Head title="New Pledge" />

    <AppLayout :breadcrumbs="[{ title: 'Pledges', href: route('pledges.index') }, { title: 'Create', href: route('pledges.create') }]">
    <div class="flex flex-col gap-4">
        <div>
            ...
            <p class="text-sm text-slate-600 dark:text-slate-300">
                Create a new pledge for a donor and an elder.
            </p>
        </div>
