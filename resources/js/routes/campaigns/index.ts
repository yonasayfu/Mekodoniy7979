...
show.url = (id: string | number, options?: RouteQueryOptions) => {
    return (
        show.definition.url.replace('{campaign}', String(id)) +
        queryParams(options)
    );
};
...
edit.url = (id: string | number, options?: RouteQueryOptions) => {
    return (
        edit.definition.url.replace('{campaign}', String(id)) +
        queryParams(options)
    );
};
...
update.url = (id: string | number, options?: RouteQueryOptions) => {
    return (
        update.definition.url.replace('{campaign}', String(id)) +
        queryParams(options)
    );
};
...
destroy.url = (id: string | number, options?: RouteQueryOptions) => {
    return (
        destroy.definition.url.replace('{campaign}', String(id)) +
        queryParams(options)
    );
};
