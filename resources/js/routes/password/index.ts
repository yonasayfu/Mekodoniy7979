...
/**
* @see \App\Http\Controllers\Auth\PasswordResetMfaController::email
* @see app/Http/Controllers/Auth/PasswordResetMfaController.php:23
* @route '/forgot-password'
*/
...
/**
* @see \App\Http\Controllers\Auth\PasswordResetMfaController::verifyCode
* @see app/Http/Controllers/Auth/PasswordResetMfaController.php:51
* @route '/verify-code'
*/
...
* @route '/enter-code'
*/
export const enterCode = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: enterCode.url(options),
    method: 'get',
})

enterCode.definition = {
    methods: ["get","head"],
    url: '/enter-code',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/enter-code'
*/
enterCode.url = (options?: RouteQueryOptions) => {
    return enterCode.definition.url + queryParams(options)
}
...
* @route '/enter-code'
*/
enterCode.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: enterCode.url(options),
    method: 'get',
})
...
* @route '/enter-code'
*/
enterCode.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: enterCode.url(options),
    method: 'head',
})
...
* @route '/enter-code'
*/
const enterCodeForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: enterCode.url(options),
    method: 'get',
})
...
* @route '/enter-code'
*/
enterCodeForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: enterCode.url(options),
    method: 'get',
})
...
* @route '/enter-code'
*/
enterCodeForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: enterCode.url({
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
const password = {
    ...
    enterCode: Object.assign(enterCode, enterCode),
}
